  ...
  return (
    <>
      <div className="p-4 max-w-[1100px] mx-auto my-0">
        <div className="flex flex-col md:flex-row mb-4 justify-between items-start">
          <input
            type="text"
            className="rounded-md h-12 outline-none shadow-md p-4 w-full md:w-[300px]"
            placeholder="Search..."
            onChange={(e) => debouncedSearch(e.target.value)}
          />
          <div className="flex flex-col lg:flex-row gap-4 mt-4 md:mt-0 items-start">
            <MultiDatePicker
